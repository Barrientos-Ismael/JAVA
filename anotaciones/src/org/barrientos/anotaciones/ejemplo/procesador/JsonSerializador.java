package org.barrientos.anotaciones.ejemplo.procesador;

import org.barrientos.anotaciones.ejemplo.Init;
import org.barrientos.anotaciones.ejemplo.JsonAtributo;
import org.barrientos.anotaciones.ejemplo.procesador.exception.JsonSerializadorException;
        ...
        return Arrays.stream(atributos).filter(f-> f.isAnnotationPresent(JsonAtributo.class))
                .map(f -> {
                    ...
                    try {
                        ...
                        throw new JsonSerializadorException("Error la serializar a json: " + e.getMessage());
                    }
                })
                .reduce("{" , (a,b) -> {
                    if ("{".equals(a))
